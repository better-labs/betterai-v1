            ...
            value: (
              process.env.NODE_ENV === 'development'
                ? [
                    ...
                    "script-src-elem 'self' 'unsafe-inline' https://www.googletagmanager.com https://auth.privy.io",
                ...
                : [
                    ...
                    "script-src-elem 'self' 'unsafe-inline' https://www.googletagmanager.com https://auth.privy.io https://*.privy.io",
